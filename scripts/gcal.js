(function() {
    ...
    gCalFlow = function() {
        ...
        gCalFlow.prototype.template = $('<div class="gCalFlow">\n  <div class="gcf-header-block">\n    <div class="gcf-title-block">\n      <span class="gcf-title"></span>\n    </div>\n  </div>\n  <div class="gcf-item-container-block">\n    <div class="gcf-item-block panel panel-default">\n      <div class="gcf-item-header-block panel-heading">\n        <div class="gcf-item-date-block">\n          <span class="gcf-item-daterange"></span>\n        </div>\n              </div>\n      <div class="gcf-item-body-block panel-body">\n   <div class="gcf-item-title-block">\n          <h3 class="gcf-item-title panel-title"></h3>\n        </div>\n     <div class="gcf-item-description">\n        </div>\n        <div class="gcf-item-location">\n        </div>\n      </div>\n    </div>\n  </div>');
        gCalFlow.prototype.opts = {
            ...
            date_formatter: function(d, allday_p) {
                ...
                if (typeof Globalize !== "undefined" && Globalize !== null && Globalize.format != null) {
                    ...
                    if (allday_p) {
                        return "" + pad_zero(d.getDate()) + "-" + pad_zero(d.getMonth() + 1) + "-" + d.getFullYear()
                    } else {
                        return "" + pad_zero(d.getDate()) + "-" + pad_zero(d.getMonth() + 1) + "-" + d.getFullYear() + " " + pad_zero(d.getHours()) + ":" + pad_zero(d.getMinutes())
                    }
                }
            },
        ...
        gCalFlow.prototype.fetch = function() {
            var success_handler, _this = this;
